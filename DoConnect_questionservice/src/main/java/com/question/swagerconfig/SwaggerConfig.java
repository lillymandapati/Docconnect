package com.question.swagerconfig;
...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        License Bealicense = new License().name("lilly License").url("https://www.lilly.com/about.html");

        Info info = new Info().title(" Question Configuration")
                               .version("V.2.0")
                               .contact(contact)
